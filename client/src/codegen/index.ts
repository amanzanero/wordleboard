...
export type LeaderboardByJoinIdQuery = { __typename?: 'Query', leaderboard: { __typename: 'Leaderboard', name: string, members: Array<{ __typename?: 'User', displayName: string }>, stats: Array<{ __typename?: 'LeaderboardStat', day: number, stats: Array<{ __typename?: 'UserStat', day: number, user: { __typename?: 'User', displayName: string }, guesses: Array<Array<{ __typename?: 'GuessState', letter: string, guess: LetterGuess }>> }> }> } | { __typename: 'LeaderboardResultError', error: LeaderboardError } };
