...
export type LeaderboardByJoinIdQuery = { __typename?: 'Query', leaderboard: { __typename: 'Leaderboard', name: string, id: string, members: Array<{ __typename?: 'User', displayName: string, id: string }>, stats: Array<{ __typename?: 'LeaderboardStat', visible: boolean, day: number, stats: Array<{ __typename?: 'UserStat', day: number, state: GameState, user: { __typename?: 'User', displayName: string, id: string }, guesses: Array<Array<{ __typename?: 'GuessState', letter: string, guess: LetterGuess }>> }> }> } | { __typename: 'LeaderboardResultError', error: LeaderboardError } };
...
export type JoinLeaderboardMutationVariables = Exact<{
  id: Scalars['String'];
}>;


export type JoinLeaderboardMutation = { __typename?: 'Mutation', joinLeaderboard: { __typename: 'Leaderboard', id: string, members: Array<{ __typename?: 'User', displayName: string }> } | { __typename: 'LeaderboardResultError', error: LeaderboardError } };
...
export const JoinLeaderboardDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"JoinLeaderboard"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"joinLeaderboard"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"__typename"}},{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Leaderboard"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"members"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"displayName"}}]}}]}},{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"LeaderboardResultError"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"error"}}]}}]}}]}}]} as unknown as DocumentNode<JoinLeaderboardMutation, JoinLeaderboardMutationVariables>;
